...
export const holoPresets: Record<HoloGrade, HoloPreset> = {
  ...
  HER: {
    ...
    intensity: 0.62,
    spectrum: "rgba(255, 31, 61, 0.46), rgba(255, 117, 86, 0.28), rgba(255, 225, 225, 0.22)",
    foil: "rgba(255, 31, 61, 0.52)",
    accent: "#ff1f3d",
    edge: "rgba(255, 31, 61, 0.92)",
    speed: 1.16
  },
  LEG: {
    grade: "LEG",
